...
2) From the command line, run "cd ./jenkins-docker/master" to navigate to the folder with the folder used to build the jenkins master

3) From the command line, run "sudo docker build -t jenkins-master ."

4) From the command line, run "cd ./jenkins-docker/slave" to navigate to the folder with the folder used to build the jenkins slave
